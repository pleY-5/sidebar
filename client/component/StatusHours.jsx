...
const StatusHours = ({ hours, isOpen }) => (
  <tr>
    <td className={styles.statusIconRow}>
      {isOpen 
        ? <img src='images/openClock.png' className={styles.statusClock}/>
        : <img src='images/closeClock.png' className={styles.statusClock}/>}
    </td>
    <td className={styles.statusHours} id='status-hours'>
      Today&nbsp;&nbsp;
      {isOpen
        ? <b>{hours.split(', ')[0]}&nbsp;&nbsp;</b>
        : <b>{hours.split(', ')[0]}<br/></b>}
      {isOpen && hours.split(', ')[1]
        ? <b><br/>{hours.split(', ')[1]}&nbsp;&nbsp;</b>
        : !isOpen && hours.split(', ')[1]
          ? <b>{hours.split(', ')[1]}&nbsp;&nbsp;</b>
          : null}
      {isOpen
